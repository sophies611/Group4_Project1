...
tele_train_labels2 <- tele_norm[-test_set2, "yyes"]
tele_test_labels2 <- tele_norm[test_set2, "yyes"]
teleknn_train_2 <- cluster_2[-test_set2,]
teleknn_test_2 <- cluster_2[test_set2,]
teleknn_model2 <- knn(train = teleknn_train_2, test = teleknn_test_2, cl = tele_train_labels2, k = 70)
plot(teleknn_model2)
