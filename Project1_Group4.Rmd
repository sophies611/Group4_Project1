...
nrow(tele_norm)
set.seed(12345)
test_set <- sample(1:nrow(cluster_1), 1000) 
...
```{r, cache=TRUE}
set.seed(12345)
test_set2 <- sample(1:nrow(cluster_2), 5000)
...
tele_log_model_2 <- glm(y~.+ maritalmarried* housingyes + educationuniversity.degree*maritalmarried, data = tele_train_2, family = "binomial")
predict_values_2 <- predict(tele_log_model_2, newdata=tele_test_2, type="response")
...
```{r, cache=TRUE}
set.seed(12345)
test_set3 <- sample(1:nrow(cluster_3), 5000)
...
tele_log_model_3 <- glm(y~.+ maritalmarried* housingyes + educationuniversity.degree*maritalmarried, data = tele_train_3, family = "binomial")
predict_values_3 <- predict(tele_log_model_3, newdata=tele_test_3, type="response")
...
```{r}
set.seed(12345)
test_set4 <- sample(1:nrow(cluster_4), 5000)
...
tele_log_model_4 <- glm(y~.+ maritalmarried* housingyes + educationuniversity.degree*maritalmarried, data = tele_train_4, family = "binomial")
predict_values_4 <- predict(tele_log_model_4, newdata=tele_test_4, type="response")
...
```{r}
set.seed(12345)
test_set5 <- sample(1:nrow(cluster_5), 5000)
...
tele_log_model_5 <- glm(y~.+ maritalmarried* housingyes + educationuniversity.degree*maritalmarried, data = tele_train_5, family = "binomial")
predict_values_5 <- predict(tele_log_model_5, newdata=tele_test_5, type="response")
...
>>>>>>> a7c889c5336fb5bd5ad4f373cc5f2a31017400d6
