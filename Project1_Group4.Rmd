...
CrossTable(x = tele_test_labels2, y = teleknn_model2, prop.chisq = FALSE)
confusionMatrix(as.factor(teleknn_model2), as.factor(tele_test_labels2), positive = "1")
```
...
CrossTable(x = tele_test_labels3, y = teleknn_model3, prop.chisq = FALSE)
confusionMatrix(as.factor(teleknn_model3), as.factor(tele_test_labels3), positive = "1")
```
