...
teleknn_train_3 <- cluster_3[-test_set3,]
teleknn_test_3 <- cluster_3[test_set3,]
#teleknn_model3 <- knn(train = teleknn_train_3, test = teleknn_test_3, cl = tele_train_labels3, k = sqrt(nrow(teleknn_train_3)))
teleknn_model3_improved <- knn(train = teleknn_train_3, test = teleknn_test_3, cl = tele_train_labels3, k = 5)
...
CrossTable(x = tele_test_labels4, y = teleknn_model4_improved, prop.chisq = FALSE)
...
CrossTable(x = tele_test_labels5, y = teleknn_model5_improved, prop.chisq = FALSE)
confusionMatrix(as.factor(teleknn_model5_improved), as.factor(tele_test_labels5), positive = "1")
```
