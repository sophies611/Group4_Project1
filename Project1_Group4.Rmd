...
cluster_2 <- tele_norm_cluster[tele_norm_cluster$cluster==1]
cluster_3 <- tele_norm_cluster[tele_norm_cluster$cluster==1]
cluster_4 <- tele_norm_cluster[tele_norm_cluster$cluster==1]
cluster_5 <- tele_norm_cluster[tele_norm_cluster$cluster==1]
```
